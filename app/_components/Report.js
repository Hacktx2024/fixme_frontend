  ...
  return (
    <div className="p-8 bg-gray-100 min-h-screen">
      <div className="bg-white p-8 rounded-md shadow-md max-w-3xl mx-auto">
        <header className="flex items-center justify-between mb-8">
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="border-b border-gray-300 pb-1 text-green-600">Male</p>
            </div>
          </div>
        </header>

        <div className="mb-6">
          <h2 className="text-lg font-semibold">Date of Illness</h2>
        ...
        <div className="mb-6">
          <h2 className="text-lg font-semibold">Active Allergies</h2>
          <p className="border-b border-gray-300 pb-1">
        ...
        <div className="mb-6">
          <h2 className="text-lg font-semibold">Current Medication</h2>
        ...
        <div className="mb-6">
          <h2 className="text-lg font-semibold mb-2">Medication</h2>
